...
namespace SehirRehberi.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IAppRepository appRepository, IMapper mapper,
            IOptions<CloundinarySettings> cloudinaryConfig)
        {
            _appRepository = appRepository;
            _mapper = mapper;

            Account account = new Account(cloudinaryConfig.Value.CloudName,
                cloudinaryConfig.Value.ApiKey, cloudinaryConfig.Value.ApiSecret);
        ...
        public ActionResult AddPhotoForCity(int cityId, [FromBody] PhotoForCreationDto photoForCreationDto)
        {
            ...
            //url den oynama ihtimaline karşı
            if (city == null)
            {
